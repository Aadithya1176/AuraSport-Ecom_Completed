...
class Users(Base):
    ...
    preferred_contact = Column(String(20), nullable=True, default="whatsapp", server_default="whatsapp")
...
class Orders(Base):
    ...
    contact_preference = Column(String(20), nullable=False, default="whatsapp", server_default="whatsapp")
